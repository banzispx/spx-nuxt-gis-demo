<template>
  <div>
    <el-table :data="tableData" style="width: 100%" border>
      ...
      <el-table-column prop="address" label="上限水位" align="center"></el-table-column>
      <el-table-column prop="address" label="下限水位" align="center"></el-table-column>
      <el-table-column prop="address" label="预警水位" align="center"></el-table-column>
